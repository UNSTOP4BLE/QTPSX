...
static const Animation char_qtm_anim[CharAnim_Max] = {
	...
	{2, (const u8[]){ 24, 25, 26, 27, ASCR_BACK, 0}},   //CharAnim_LeftAlt
	{2, (const u8[]){ 12, 13, 14, 15, ASCR_BACK, 0}},         //CharAnim_Down
	{2, (const u8[]){ 28, 29, 30, 31, ASCR_BACK, 0}},   //CharAnim_DownAlt
	{2, (const u8[]){ 16, 17, 18, 19, ASCR_BACK, 0}},         //CharAnim_Up
	{2, (const u8[]){ 32, 33, 34, 35, ASCR_BACK, 0}},   //CharAnim_UpAlt
	{2, (const u8[]){ 20, 21, 22, 23, ASCR_BACK, 0}},         //CharAnim_Right
	{2, (const u8[]){ 36, 37, 38, 39, ASCR_BACK, 0}},   //CharAnim_RightAlt
